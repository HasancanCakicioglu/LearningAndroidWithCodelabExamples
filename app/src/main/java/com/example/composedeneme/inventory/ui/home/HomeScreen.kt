...
package com.example.composedeneme.inventory.ui.home
...
import com.example.composedeneme.inventory.InventoryTopAppBar
import com.example.composedeneme.inventory.data.Item
import com.example.composedeneme.inventory.ui.AppViewModelProvider
import com.example.composedeneme.inventory.ui.navigation.NavigationDestination
import com.example.composedeneme.inventory.ui.theme.InventoryTheme
...
private fun HomeBody(
    ...
    Column(
        ...
        if (itemList.isEmpty()) {
            ...
            InventoryList(itemList = itemList, onItemClick = {
                onItemClick(it.id) })
        }
    }
}
