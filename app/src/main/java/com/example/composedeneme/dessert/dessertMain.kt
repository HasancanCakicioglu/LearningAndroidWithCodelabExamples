package com.example.composedeneme.dessert
...
import com.example.composedeneme.dessert.data.Datasource.dessertList
...
fun MyDessertClickerAppPreview() {
    ComposedenemeTheme() {
        DessertClickerApp(listOf(Dessert(R.drawable.image1, 5, 0)))
    }
}